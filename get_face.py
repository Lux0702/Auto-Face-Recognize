...
path=os.path.abspath('./image/'+nameID)
...
school_year=str(input("Enter Year you enter school: "))
academic_year=str(input("Enter Your Academic Year : "))
data = {
    nameID:
        {
            "Tên": name,
    ...
    while (dem<500):
        ...
        if (True):
            if faces[1] is not None:
                ...
                file_name = path +'/'+nameID+'_%04d.bmp' % dem
